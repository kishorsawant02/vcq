...
var _registrationEmailFormat = function (user) {
    var registrationEmailTemplate = '   <body style="font-family:Arial, Helvetica, sans-serif; margin:0; padding:0; background-color:#ffffff">  ' +
        ...
        '                 <font>Thank Your Registration is successfull ' +
        '                 </font>  ' +
        '               </div>  ' +
        '             </td>  ' +
        '           </tr>  ' +
        ...
        '                         Your mobile number would be uer login id - </td>  ' +
        '                     </tr>  ' +
        '                   </tbody>  ' +
        '                 </table>  ' +
        ...
        '                   <tbody>  ' +
        '                     <tr>  ' +
        '                       <td align="center" valign="top" style="font-size: 20px;width:100%;color: #ffffff;padding: 28px 10px;">  ' + user.mobile +
        '                       </td>  ' +
        '                     </tr>  ' +
        '                   </tbody>  ' +
        '                 </table>  ' +
        ...
        '                         Please donot share your password with any one.  ' +
        '                       </td>  ' +
        '                     </tr>  ' +
        '                   </tbody>  ' +
        '                 </table>  ' +
